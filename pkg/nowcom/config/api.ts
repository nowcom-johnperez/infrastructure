  ...
  if (typeof window !== 'undefined') {
    ...
    if (hostname.includes('clouddev')) {
      config = {
        ...
        RANCHER_BEARERTOKEN: 'prod-rancher-bearer-token'
      };
    } else {
      config = {
        NETWORK_URL_V2: 'https://packetlifter-int.hankeyinvestments.com/',
